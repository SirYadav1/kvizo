                ...
                Row(horizontalArrangement = Arrangement.spacedBy(10.dp)) {
                    row.forEach { emoji ->
                        ...
                        LaunchedEffect(selected) {
                            if (selected) selScale.animateTo(1.18f, spring(dampingRatio = 0.45f, stiffness = 550f))
                        ...
                        Box(
                            modifier = Modifier
                                ...
                                .background(if (selected) Violet.copy(alpha = 0.18f) else MaterialTheme.colorScheme.surfaceVariant, CircleShape)
                                .border(if (selected) 2.dp else 0.dp, if (selected) Violet else MaterialTheme.colorScheme.surfaceVariant, CircleShape)

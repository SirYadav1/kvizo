...
class AppViewModel(app: Application) : AndroidViewModel(app) {
    ...
    private val communityQuizManager = com.kvizo.app.data.CommunityQuizManager(app)
    ...
    suspend fun fetchCommunityQuizzes(): Result<List<com.kvizo.app.data.CommunityQuiz>> {
    ...
    fun importCommunityQuiz(quiz: com.kvizo.app.data.CommunityQuiz) {

...
import com.kvizo.app.ui.components.XpPopup
            ...
            Column(modifier = Modifier.fillMaxSize().statusBarsPadding().navigationBarsPadding()) {
                ...
                Row(
                    ...
                    TextButton(onClick = { submit() }) {
                        Text("Submit", color = com.kvizo.app.ui.theme.Violet, fontWeight = FontWeight.Bold, fontSize = 13.sp)
                    }
                }
                    ...
                    LazyColumn(
                        ...
                        item {
                            Row(verticalAlignment = Alignment.CenterVertically) {
                                com.kvizo.app.ui.components.ForgeKicker(
                        ...
                        if (revealed) {
                            item {
                                com.kvizo.app.ui.components.PressGlowButton(
                                    onClick = { next() },
                                    modifier = Modifier.fillMaxWidth(),
                                    shape = RoundedCornerShape(14.dp),
                ...
                Box(
                    ...
                    Surface(shape = RoundedCornerShape(24.dp), color = MaterialTheme.colorScheme.surface, shadowElevation = 10.dp) {
                        Column(horizontalAlignment = Alignment.CenterHorizontally, modifier = Modifier.padding(horizontal = 34.dp, vertical = 26.dp)) {
                            Icon(Icons.Filled.PlayArrow, contentDescription = null, tint = com.kvizo.app.ui.theme.Violet, modifier = Modifier.size(34.dp))
...
private fun TimerChip(text: String, color: Color) {
    Surface(
        ...
        border = androidx.compose.foundation.BorderStroke(1.dp, com.kvizo.app.ui.theme.RedBorder)
    ) {
        Row(
            verticalAlignment = Alignment.CenterVertically,
            ...
            Text(" $text", color = color, fontFamily = com.kvizo.app.ui.theme.SpaceGrotesk, fontWeight = FontWeight.Bold, fontSize = 12.sp)
        }
    }
}
